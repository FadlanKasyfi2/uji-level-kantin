        ...
        @include('partial.topbar')
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <span>
                    <a href="{{ url('form') }}" class="text-primary float-right">
                        <i class="fas fa-plus"><span class="ml-2">Add Menu</span></i>
                    </a>
                </span>
              </h6>
            </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a class="btn btn-warning" href="{{ route ('edit.menu', $menu_kantin->id) }}">Edit</a>
                            <a onclick="return confirm('Seriusan?')" class="btn btn-danger" href="{{ route ('delete.menu', $menu_kantin->id) }}">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                  </tbody>
